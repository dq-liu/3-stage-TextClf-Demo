    ...
    class MyHandler(server.BaseHTTPRequestHandler):
        def do_GET(self):
            ...
            if self.path == '/':
                ...
                self.wfile.write(b"<style type='text/css'> iframe#ifrm {z-index:1000; position:absolute; left:600px; top:25px; border:1px solid #ccc; width:50%; height:90%;}</style>")
                self.wfile.write(b"<iframe name='ifrm' id='ifrm' scrolling='auto'></iframe>")
